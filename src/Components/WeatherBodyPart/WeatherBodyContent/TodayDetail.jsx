                ...
                <Col sm={12} md lg={8}>
                    <Row>
                        <Col className={css.Body}>
                            ...
                            <div className={css.Margin}><span><img className={css.Icons}
                                                                   src="https://img.icons8.com/emoji/48/000000/sun-emoji.png" alt={'a'}/></span>Day: {Math.round(props.FiveDayForCast.daily[0].feels_like.day)} {props.measure === 'metric' ?
                    ...
                    <Row>
                        ...
                        <Col className={css.Body}>
                            ...
                            <div className={css.Margin} style={{width: '100px', margin: "auto"}}>
                                <CircularProgressbarWithChildren value={props.data.visibility / 1000} maxValue={10}
                                    ...
                                    <img className={css.Icons}
                                         src="https://img.icons8.com/external-flaticons-lineal-color-flat-icons/64/000000/external-visibility-diving-flaticons-lineal-color-flat-icons-2.png"/>
                        ...
                        <Col className={css.Body}>
                            ...
                            <div
                                className={css.Margin}><span><img className={css.Icons}
                                                                  src="https://img.icons8.com/color/48/000000/cold.png"/></span>Min: {Math.round(props.FiveDayForCast.daily[0].temp.min)}{props.measure === 'metric' ?
                                <sup>&deg;C</sup> : <sup>&deg;F</sup>}</div>
                            <div className={css.Margin}><span><img className={css.Icons}
                                                                   src="https://img.icons8.com/office/30/000000/temperature--v1.png"/></span>Max: {Math.round(props.FiveDayForCast.daily[0].temp.max)}{props.measure === 'metric' ?
                                <sup>&deg;C</sup> : <sup>&deg;F</sup>}</div>
